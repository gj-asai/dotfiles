return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<C-b>", function() harpoon:list():select(4) end, { desc = "Harpoon select 4" })
        ...
        vim.keymap.set("n", "<leader><C-b>", function() harpoon:list():replace_at(4) end, { desc = "Harpoon replace at 4" })
    end,
}
